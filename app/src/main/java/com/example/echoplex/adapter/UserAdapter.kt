...
import com.example.echoplex.ChatActivity
import com.example.echoplex.R
import com.example.echoplex.databinding.ItemProfileBinding
...
RecyclerView.Adapter<UserAdapter.UserViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: UserViewHolder, position: Int) {
        ...
        holder.binding.itemProfileName.text = user.name
        Glide.with(context).load(user.profileImage)
            .placeholder(R.drawable.userimg)
            .into(holder.binding.itemProfileImg)
